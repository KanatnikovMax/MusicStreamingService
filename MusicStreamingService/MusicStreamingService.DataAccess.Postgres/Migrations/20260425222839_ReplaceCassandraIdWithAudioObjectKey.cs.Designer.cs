...
namespace MusicStreamingService.DataAccess.Postgres.Migrations
{
    ...
    [Migration("20260425222839_ReplaceCassandraIdWithAudioObjectKey.cs")]
    partial class ReplaceCassandraIdWithAudioObjectKeycs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicStreamingService.DataAccess.Postgres.Entities.Playlist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("MusicStreamingService.DataAccess.Postgres.Entities.PlaylistSong", b =>
                {
                    ...
                    b.ToTable("playlists_songs", (string)null);
                });
            ...
            modelBuilder.Entity("MusicStreamingService.DataAccess.Postgres.Entities.PlaylistSong", b =>
                {
                    b.HasOne("MusicStreamingService.DataAccess.Postgres.Entities.Playlist", "Playlist")
